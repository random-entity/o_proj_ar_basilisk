 ...
 * - Broadcasted parameterized-preset-protocol (BPPP) Commands
 *   <- Recognized iff source address is a Commander's && oneshots .
 *   -> Set waiting parse flag and parse at next ExecutionCycle.
 * - Poll Commands
 *   <-
